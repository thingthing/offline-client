            ...
            checkPassword : function(login, password) {
                ...
                if (currentLogin){
                    if (password == currentLogin.password){
                        ...
                        return {result : false,reason : "passwordMismatch", reasonLabel : this.translate.get("passwordManager.passwordMismatch")};
                    }
                }
                return {result : false, reason : "loginUnknown", reasonLabel : this.translate.get("passwordManager.loginUnknown")};
            },
